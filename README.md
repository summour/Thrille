...
```
(คำปรารภ) / (ข้อความเบื้องต้น) / บรรพ / ภาค → ลักษณะ → หมวด → ส่วน → มาตรา
```

โครงสร้างจริงไม่สม่ำเสมอ ระบบจึงออกแบบให้ **ข้ามระดับได้**  
- **คำปรารภ** อยู่ระดับบนสุดสำหรับบทนำ/ประกาศพระบรมราชโองการก่อนเริ่มหมวดหมู่
- **ข้อความเบื้องต้น** อยู่ในระดับบนสุดก่อนเริ่มบรรพ ๑ (เช่น มาตรา ๑–๓ ของ ป.พ.พ.)
- โหนดหนึ่งในสารบัญมีได้ทั้ง `children` (ระดับย่อย) และ/หรือ `articleIds` (มาตราของตัวเอง)
